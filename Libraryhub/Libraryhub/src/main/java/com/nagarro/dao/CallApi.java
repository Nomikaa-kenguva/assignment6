...
//             }
	...
	public void deleteData(String bookId) throws InterruptedException, ExecutionException, IOException {
		HttpClient client = HttpClient.newHttpClient();
        HttpRequest request = HttpRequest.newBuilder()
	...
	public void updateBook(String bookId, Books updatedBook) throws InterruptedException, ExecutionException, IOException {
	    ...
	    if (statusCode == 200) {
	        ...
	        System.out.println("Error updating book. Status code: " + statusCode);
	    }
	}
